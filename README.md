...
Step 1: Download Python 3.9 or above. [Link](https://www.python.org/downloads/)
...
**Docker Support**: For a portable, cross-platform setup, see [`README.Docker.md`](README.Docker.md) for Docker instructions.
...
optional arguments:
  ...
  -m MODE, --mode MODE  Mode for separating text and known vocab: 'smart' (default, word-by-word using jieba segmentation) 'simple' (character-by-character)
